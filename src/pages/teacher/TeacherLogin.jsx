...
export default function TeacherLogin() {
  ...
  const handleLogin = async (e) => {
    ...
    try {
      const res = await ApiServices.validateTeacher({ email, password });
      
      if (res.status) {
        // Successful login
        login('teacher', {
          userID: res.teacherID,
          userName: res.teacherName,
          email: email
        }, rememberMe);
        navigate('/teacher');
      } else {
    ...
    <div className="teacher-theme" style={{
      ...
      <div className="animate-fade-in glass-card" style={{
        ...
        <p style={{
          ...
          Enter your email and password to access panel
        </p>
        ...
        <form onSubmit={handleLogin} style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
          <div className="form-group">
            <label className="form-label" htmlFor="teacher-email">University Email</label>
